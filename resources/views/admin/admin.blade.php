...
<body>
	<div id="app">
		<admin-main name="{{$name_admin}}" img="{{asset('themeAdmin/assets/images/avatar-1.jpg')}}"/>
	</div>
    ...
    {{-- <!-- chart chartist js -->
    <script src="{{asset('themeAdmin/assets/vendor/charts/chartist-bundle/chartist.min.js')}}"></script> --}}
    <!-- sparkline js -->
    ...
    {{-- <script src="{{asset('themeAdmin/assets/libs/js/dashboard-ecommerce.js')}}"></script> --}}
