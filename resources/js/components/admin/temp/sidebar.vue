                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <a class="nav-link" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fa fa-fw fa-user-circle"></i>Danh mục bài viết</a>
                                <div id="submenu-1" class="collapse submenu "><!--thêm class show có nghĩa là đang xổ xuống menu -->
                                     <ul class="nav flex-column"> 

                                        <li class="nav-item">
                                            <router-link to=/ListCategory class=nav-link>Danh sách danh mục bài viết</router-link>
                                        </li>
                                        <li class="nav-item">
                                            <router-link to=/NewCategory class=nav-link>Thêm danh mục bài viết</router-link>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" >
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <router-link to=/addPosts class="nav-link" href="pages/general.html">Thêm bài viết</router-link>                                           
                                        </li>
                                        <li class="nav-item">
